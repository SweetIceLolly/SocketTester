...
Private Sub cmdConnect_Click()
    ...
    Me.wsMain.Close
    Me.wsMain.Connect Me.edServerIP.Text, Me.edServerPort.Text
End Sub
...
Private Sub edServerIP_KeyPress(KeyAscii As Integer)
    If KeyAscii = 13 Then
        KeyAscii = 0
        Me.edServerPort.SetFocus
    End If
End Sub
